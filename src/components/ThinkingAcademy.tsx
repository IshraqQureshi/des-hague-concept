    ...
    >
      ...
      <Container className="relative">
        <Reveal className="text-center">
          <span className="text-[11px] font-medium uppercase tracking-[0.3em] text-ivory-dim/50">
          ...
          <p className="mx-auto mt-8 max-w-[54ch] text-[17px] leading-[1.75] text-ivory-dim/75 md:text-[18px]">
        ...
        <StaggerGroup className="mx-auto mt-10 flex max-w-4xl flex-wrap items-center justify-center gap-x-10 gap-y-6 border-y border-ivory/15 py-6">
          {FEATURES.map((f) => (
            <StaggerItem key={f}>
              <span className="text-[13px] font-medium uppercase tracking-[0.14em] text-ivory-dim/75">
                {f}
              </span>
            </StaggerItem>
          ))}
